...
static int s3c_camif_output_pp_codec_rgb(camif_cfg_t *cfg)
{
	...
	{
		val = readl(cfg->lcd_regs + 0*8 + VIDW_BUF_START(0));
...
{
	// TODO: Use LCD direct path instead of memory to memory transfers
...
static int s3c_camif_io_duplex_preview(camif_cfg_t *cfg)
{
	...
	val = readl(cfg->lcd_regs + 1*8 + VIDW_BUF_START(0));
...
static struct s3c_gpio_config camif_gpio_table[] = {
	S3C_GPIO_ALIVE_EXT(CAM_MCLK, NONE, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE_EXT(CAM_HSYNC, NONE, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE_EXT(CAM_PCLK, NONE, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE_EXT(MCAM_RST_N, LOW, NONE, OUT0, NONE),
	S3C_GPIO_ALIVE_EXT(CAM_VSYNC, NONE, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE_EXT(CAM_D_0, NONE, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE_EXT(CAM_D_1, NONE, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE_EXT(CAM_D_2, NONE, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE_EXT(CAM_D_3, NONE, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE_EXT(CAM_D_4, NONE, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE_EXT(CAM_D_5, NONE, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE_EXT(CAM_D_6, NONE, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE_EXT(CAM_D_7, NONE, DOWN, INPUT, DOWN),
};

static struct s3c_gpio_config camif_idle_gpio_table[] = {
	S3C_GPIO_ALIVE(CAM_MCLK, OUTPUT, LOW, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE(CAM_HSYNC, OUTPUT, LOW, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE(CAM_PCLK, OUTPUT, LOW, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE(MCAM_RST_N, OUTPUT, LOW, NONE, OUT0, NONE),
	S3C_GPIO_ALIVE(CAM_VSYNC, OUTPUT, LOW, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE(CAM_D_0, OUTPUT, LOW, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE(CAM_D_1, OUTPUT, LOW, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE(CAM_D_2, OUTPUT, LOW, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE(CAM_D_3, OUTPUT, LOW, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE(CAM_D_4, OUTPUT, LOW, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE(CAM_D_5, OUTPUT, LOW, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE(CAM_D_6, OUTPUT, LOW, DOWN, INPUT, DOWN),
	S3C_GPIO_ALIVE(CAM_D_7, OUTPUT, LOW, DOWN, INPUT, DOWN),	
};

int s3c_camif_set_gpio(int idle)
{
	if (idle)
		s3c_init_gpio(camif_idle_gpio_table,
					ARRAY_SIZE(camif_idle_gpio_table));
	else
		s3c_init_gpio(camif_gpio_table, ARRAY_SIZE(camif_gpio_table));
